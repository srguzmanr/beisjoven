                    ...
                    <div class="admin-content">
                        ...
                        <div class="media-gallery" id="media-gallery">
                            ${imagenes.length > 0 ? imagenes.map(img => `
                                <div class="media-item" data-url="${img.url}" data-nombre="${img.nombre}">
                                    <img src="${img.url}" alt="${img.nombre}" loading="lazy">
                                    <div class="media-overlay">
                                        <button class="btn-icon" onclick="AdminPages.copiarUrl('${img.url}')" title="Copiar URL">📋</button>
                                        <button class="btn-icon btn-danger" onclick="AdminPages.eliminarImagen('${img.nombre}')" title="Eliminar">🗑️</button>
                                    </div>
                                </div>
                            `).join('') : `
